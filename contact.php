...
<head>
    ...
    <title>Mediakor - Contact Us</title>
    <!-- Tailwind CSS CDN -->
    ...
    <div class="flex flex-1 container mx-auto my-6 p-4 bg-white rounded-lg shadow-xl">
        ...
        <aside class="w-1/4 pr-6 border-r border-gray-200">
            <nav>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="page5.php" class="block py-2 px-3 rounded-md text-blue-600 hover:bg-blue-50 hover:text-blue-700 transition-colors duration-200"></a></li>
                </ul>
            </nav>
        </aside>
        ...
        <main class="flex-1 pl-6">
            ...
            <p class="text-gray-700 leading-relaxed mb-4">
                You can reach out to us at AtlaskorPC@gmail.com. 
            </p>
            <p class="text-gray-700 leading-relaxed mb-4">
                I live in Mountain Time (Denver time), and I check my email regularly.
            </p>
            ...
            <section class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">AtlaskorPC@gmail.com</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Who Am I?</h3>
                    <p class="text-gray-600">I am Donnie Pritchard, I work for an ISP and play in sysadmin and datacenter fields on my spare time.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">Own Your Data</h3>
                    <p class="text-gray-600">With security being a huge issue with corporations, maintain your own backend, preventing intrusions to the big players.</p>
                </div>
            </section>
        </main>
    </div>
